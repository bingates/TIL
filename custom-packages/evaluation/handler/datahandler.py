from ..stat.statistics import Stat
#from ..stat.statistics import Stat, aaa
#from ..stat import statistics

from openpyxl import load_workbook

#class DataHandler(Stat): # is-a
class DataHandler:

    # class member
    # 모든 datahandler 객체가 공유해서 사용함
    evaluator=Stat() #composition : has-a -> 애매한 상황에선 has-a : is-a 와 성능상의 차이 없음
    #evaluator=statistics.Stat()
